...
// Note: Sound effects are temporarily disabled due to migration from expo-av to expo-audio
// This functionality can be reimplemented using expo-audio's API if needed

export async function playSfx(soundPath: any, delay = 0) {
  // Sound effects temporarily disabled
  console.log("SFX temporarily disabled:", soundPath);
}
